...
The Iris examples are distributed under the http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/[UK's Open Government Licence] and copyright British Crown 2014.
